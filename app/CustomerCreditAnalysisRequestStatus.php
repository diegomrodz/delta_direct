...
class CustomerCreditAnalysisRequestStatus extends Model
{
    /**
    ...
    * @var string
    */
    protected $table = 'customer_credit_analysis_request_status';
    ...
    * @var string
    */
    protected $primaryKey = 'customer_credit_analysis_request_status_id';
