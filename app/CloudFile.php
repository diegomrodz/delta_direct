...
class CloudFile extends Model
{
     ...
     * @var string
     */
    protected $primaryKey = 'cloud_file_id';
     ...
     * @var array
     */
    protected $fillable = ['user_id', 'cloud_directory_id', 'description', 'filename', 'util', 'filepath', 'entity_id', 'active', 'created_at', 'updated_at'];
    ...
    {
        return CloudDirectory::where('cloud_directory_id', $this->cloud_directory_id)->first();
    }
