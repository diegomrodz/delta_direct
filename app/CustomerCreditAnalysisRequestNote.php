...
class CustomerCreditAnalysisRequestNote extends Model
{
    /**
    ...
    * @var string
    */
    protected $table = 'customer_credit_analysis_request_note';
    ...
    * @var array
    */
    protected $fillable = ['distribuitor_id', 'from_id', 'text', 'active', 'created_at', 'updated_at'];

    public function user() 
    {
        return User::where('user_id', $this->from_id)->first();
    }
