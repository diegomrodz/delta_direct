...
class DistribuitorPortfolio extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'distribuitor_portfolio';
     ...
     * @var array
     */
    protected $fillable = ['distribuitor_id', 'customer_id', 'active', 'created_at', 'updated_at'];
