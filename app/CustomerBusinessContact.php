...
class CustomerBusinessContact extends Model
{
	    /**
     ...
     * @var string
     */
    protected $primaryKey = 'customer_business_contact_id';
     ...
     * @var array
     */
    protected $fillable = ['customer_id', 'crm_id', 'name', 'email', 'phone', 'dept', 'active', 'created_at', 'updated_at'];
