...
class ProductTransferPrice extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'product_transfer_price';
     ...
     * @var string
     */
    protected $primaryKey = 'product_transfer_price_id';
     ...
     * @var array
     */
    protected $fillable = ['value', 'distribuitor_id', 'active', 'created_at', 'updated_at'];
