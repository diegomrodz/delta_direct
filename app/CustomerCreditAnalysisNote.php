...
class CustomerCreditAnalysisNote extends Model
{
    /**
    ...
    * @var string
    */
    protected $table = 'customer_credit_analysis_note';
    ...
    * @var array
    */
    protected $fillable = ['from_id', 'text', 'active', 'created_at', 'updated_at'];
