...
class ProjectInfluencer extends Model
{
     ...
     * @var string
     */
    protected $table = 'project_influencer';
     ...
     * @var array
     */
    protected $fillable = ['project_id', 'influencer_id', 'customer_id', 'level', 'active', 'created_at', 'updated_at'];

    public function project() 
    {
        return Project::where('project_id', $this->project_id)->first();
    }
