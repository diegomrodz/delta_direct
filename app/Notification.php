...
class Notification extends Model
{
    ...
    {
        return NotificationSubject::where("notification_subject_id", $this->subject_id)->first();    
    }
    
    public function getStatus() 
    {
        return NotificationStatus::where("notification_status_id", $this->status_id)->first();
    }
    
    public function from() 
    {
        return User::where('user_id', $this->from_user_id)->first();
    }
    
    public function to() 
    {
        return User::where('user_id', $this->to_user_id)->first();
    }
}