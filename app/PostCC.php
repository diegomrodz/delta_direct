...
class PostCC extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['post_id', 'cc_id', 'active', 'created_at', 'updated_at'];
    ...
    {
        return User::where('user_id', $this->cc_id)->first();
    }
