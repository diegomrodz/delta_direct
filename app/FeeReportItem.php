...
class FeeReportItem extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'fee_report_item';
     ...
     * @var array
     */
    protected $fillable = ['fee_report_id', 'installment_id', 'installment_status_id', 'active', 
    ...
    {
        return InstallmentStatus::where('installment_status_id', $this->installment_status_id)->first();
    }
