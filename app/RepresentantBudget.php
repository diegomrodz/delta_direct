...
class RepresentantBudget extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'representant_budget';
     ...
     * @var string
     */
    protected $primaryKey = 'representant_budget_id';
    ...
    protected $fillable = [
        ...
        'manager_id',
        'distribuitor_id',
        'representant_budget_payment_condition_id',
        'payment_details',
        'email_filepath',
        'product_values',
        'grand_total',
    ...
    public function getAllPaymentConditions() 
    {
        return RepresentantBudgetPaymentCondition::where('active','s')->get();
    }
    ...
    {
        return RepresentantBudgetPaymentCondition::where('representant_budget_payment_condition_id', $this->representant_budget_payment_condition_id)->first();
    }
    
    public function getProducts() 
    {
        return RepresentantBudgetProduct::where('representant_budget_id', $this->representant_budget_id)
                                        ->where('active', 's')
                                        ->get();
    }
