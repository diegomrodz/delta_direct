...
class CustomerCreditAnalysisRequest extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'customer_credit_analysis_request';
     ...
     * @var array
     */
    protected $fillable = ['distribuitor_id', 
                           'customer_credit_analysis_request_status_id', 
                           'credit_analysis_range_id', 
                           'active', 
                           'created_at', 
                           'updated_at'];
    ...
    {
        return CustomerCreditAnalysis::where('customer_credit_analysis_id', $this->customer_credit_analysis_id)->first();
    }
    
    public function range() 
    {
        return CustomerCreditAnalysisRange::where('customer_credit_analysis_range_id', $this->credit_analysis_range_id)->first();
    }
