...
class CustomerMainProvider extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'customer_main_provider';
     ...
     * @var string
     */
    protected $primaryKey = 'customer_main_provider_id';
     ...
     * @var array
     */
    protected $fillable = ['customer_id', 'name', 'email', 'phone', 'company', 'active', 'created_at', 'updated_at'];
