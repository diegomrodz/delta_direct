...
class ProductConsumerPrice extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'product_consumer_price';
     ...
     * @var string
     */
    protected $primaryKey = 'product_consumer_price_id';
     ...
     * @var array
     */
    protected $fillable = ['value_s_ipi', 'value_c_ipi', 'mark_up', 'created_at', 'updated_at'];
