...
{
    private $kitchen = [1];
    private $bathroom = [3,6,8,12];
    private $laundry = [2];
    private $accessories = [5,7,9];
    private $others = [10, 13];
    
    public function category() 
    {
        if ( in_array($this->product_function_id, $this->kitchen) ) 
        {
            return "Cozinha";
        }
        else if ( in_array($this->product_function_id, $this->bathroom) )
        {
            return "Banheiro";
        }
        else if ( in_array($this->product_function_id, $this->laundry) )
        {
            return "Lavanderia";
        }
        else if ( in_array($this->product_function_id, $this->accessories) ) 
        {
            return "Acessórios";
        }
        else 
...
{   
    ...
    {
        $products = CatalogProduct::whereIn('product_vrc_id', [1,3])->where('active', 's')->get();
        ...
        {
            array_push($catalog[$product->category()], $product);
        }
