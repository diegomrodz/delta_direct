...
class TutorialController extends Controller
{
    ...
    {
        return view("tutorials.portfolio", ["user" => Auth::user()]);
    }
    
    public function budgets() 
    {
        return view("tutorials.budget", ["user" => Auth::user()]);
    }
    
    public function orders() 
    {
        return view("tutorials.order", ["user" => Auth::user()]);
    }
    
    public function fees() 
    {
        return view("tutorials.fees", ["user" => Auth::user()]);
    }
}