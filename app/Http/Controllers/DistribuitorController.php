...
class DistribuitorController extends Controller
{
    ...
    {
        return view('distribuitor.area.view', ['user' => Auth::user()]);
    }
    
    public function showPolice($dist_id) 
    {
        $distribuitor = Distribuitor::where('distribuitor_id', $dist_id)->first();
        
        return view("distribuitor.police.show", ['distribuitor' => $distribuitor]);
    }
    
    public function find($dist_id) 
    {
        return Distribuitor::where('distribuitor_id', $dist_id)->first();
    }
