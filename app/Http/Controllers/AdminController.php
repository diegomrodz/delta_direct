...
class AdminController extends Controller
{
    ...
    public function sendInvitation(Request $request) 
    {
        ...
        {
            return view('admin.send_invitation',  ['user' => Auth::user()]);
        }
        ...
        $type = UserType::where('cod', $request->userType)->first();

        $tempUser->user_type = $type->user_type_id;

        $tempUser->save();

        Mail::send('emails.invitation', ['user' => $tempUser], function ($m) use ($tempUser){
            $m->to($tempUser->email, $tempUser->name)->subject("Delta Direct :: Convite");
        });
    ...
    {
        return view('admin.new_user', ['user' => Auth::user()]);
    }
    ...
    public function postNewUser(Request $request) 
    {
        ...
        if ($user->getUserType()->cod == 10) 
        {
            ...
            $rep->manager_id = $request->input("rep_manager");
            $rep->representant_company_id = $request->input("rep_company");
            
            $rep->save();
            
            $rel = new RepresentantPortfolio;
            
            $rel->representant_id = $rep->representant_id;
            $rel->customer_id = 151;
        ...
        else if ($user->getUserType()->cod == 20)
        {
            ...
            $rel = new ManagerPortfolio;
            
            $rel->manager_id = $mng->manager_id;
            $rel->customer_id = 151;
        ...
        else if ($user->getUserType()->cod == 5)
        {
            ...
            $rel = new DistribuitorPortfolio;
            
            $rel->distribuitor_id = $dist->distribuitor_id;
            $rel->customer_id = 151;
    ...
    public function postNewRepCompany(Request $request) 
    {
        $rep = new RepresentantCompany;
    
        $rep->name = $request->name;
        $rep->nickname = $request->nickname;
        $rep->has_shared_portfolio = $request->has_shared_portfolio;
        $rep->cnpj = $request->cnpj;
        $rep->ie = $request->ie;
        $rep->phone = $request->phone;
        $rep->phone2 = $request->phone2;
        $rep->bank_name = $request->bank_name;
        $rep->bank_agency = $request->bank_agency;
        $rep->bank_cc = $request->bank_cc;
        $rep->email = $request->email;
        $rep->address = $request->address;
        $rep->city = $request->city;
        $rep->district = $request->district;
    ...
    public function getNewRepCompany() 
    {
        $user = Auth::user();
        
        return view('admin.new_rep_company', ['user' => $user]);
    }
    ...
    public function listUsers() 
    {
        ...
        return view('admin.list_users', ['user' => $user, 'users' => $users]);
    }
}