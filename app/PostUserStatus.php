...
class PostUserStatus extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'post_user_status';
     ...
     * @var array
     */
    protected $fillable = ['post_id', 'user_id', 'has_been_seen', 'important', 'active', 'created_at', 'updated_at'];

    public function post() 
    {
        return Post::where('post_id', $this->post_id)->first();
    }
