...
class RepresentantCompany extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'representant_company';
     ...
     * @var string
     */
    protected $primaryKey = 'representant_company_id';
     ...
     * @var array
     */
    protected $fillable = ['name', 'cnpj', 'has_shared_portfolio', 'active', 'created_at', 'updated_at'];
    
    public function representants() 
    {
        return Representant::where('representant_company_id',  $this->representant_company_id)->get();
    }
