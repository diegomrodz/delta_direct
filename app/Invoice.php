...
class Invoice extends Model
{
    ...
    {
        return Installment::where('invoice_id', $this->invoice_id)->where('active', 's')->whereIn('installment_status_id', [1, 2])->get();
    }
    
    public function status() 
    {
        return InvoiceStatus::where('invoice_status_id', $this->invoice_status_id)->first();    
    }
    
    public function order() 
    {
        return SubOrder::where('sub_order_id', $this->sub_order_id)->first();
    }
    
    public function getProducts() 
    {
        return InvoiceItem::where('invoice_id', $this->invoice_id)->get();
    }
