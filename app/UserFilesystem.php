...
class UserFilesystem extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'user_filesystem';
     ...
     * @var array
     */
    protected $fillable = ['storage_file_id', 'active', 'created_at', 'updated_at'];
    
    public function getFile() 
    {
        return StorageFile::where('storage_file_id', $this->storage_file_id)->first();
    }
