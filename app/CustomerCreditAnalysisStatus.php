...
class CustomerCreditAnalysisStatus extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'customer_credit_analysis_status';
     ...
     * @var string
     */
    protected $primaryKey = 'customer_credit_analysis_status_id';
