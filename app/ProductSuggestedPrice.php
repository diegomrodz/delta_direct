...
class ProductSuggestedPrice extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'product_suggested_price';
     ...
     * @var string
     */
    protected $primaryKey = 'product_suggested_price_id';
     ...
     * @var array
     */
    protected $fillable = ['value', 'active', 'created_at', 'updated_at'];
