...
class CustomerSanitaryMetalsSupplier extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'customer_sanitary_metals_supplier';
     ...
     * @var string
     */
    protected $primaryKey = 'sanitary_metals_supplier_id';
     ...
     * @var array
     */
    protected $fillable = ['customer_id', 'active', 'created_at', 'updated_at'];
    
    public function getSanitaryMetalsSupplier() 
    {
        return SanitaryMetalsSupplier::where('sanitary_metals_supplier_id', $this->sanitary_metals_supplier_id)->first();    
    }
