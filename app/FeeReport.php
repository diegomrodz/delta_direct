...
class FeeReport extends Model
{
     ...
     * @var string
     */
    protected $primaryKey = 'fee_report_id';
     ...
     * @var array
     */
    protected $fillable = ['representant_company_id', 'representant_id', 'manager_id', 'distribuitor_id', 'is_paid', 'nfe_filepath', 'active', 
    ...
    {
        return FeeReportItem::where('fee_report_id', $this->fee_report_id)->get();
    }
    ...
    public function total() 
    {
        ...
        {
            $total += ($item->installment()->invoice()->product_value / count($item->installment()->invoice()->getInstallments())) * 0.05;
        }
