...
class SubOrder extends Model
{
    ...
    protected $fillable = [
        ...
        'manager_id',
        'customer_id',
        'representant_company_id',
        'sub_order_status_id',
        'sub_order_payment_condition_id',
    ...
    {
        return $this->order()->representant();
    }
    
    public function getProducts() 
    {
        return SubOrderProduct::where('sub_order_id', $this->sub_order_id)->where('active', 's')->get();
    }
    
    public function paymentCondition() 
    {
        return SubOrderPaymentCondition::where('sub_order_payment_condition_id', $this->sub_order_payment_condition_id)->first();
    }
    
    public function getStatus() 
    {
        return SubOrderStatus::where('sub_order_status_id', $this->sub_order_status_id)->first();
    }
    
    public function getInvoices() 
    {
        return Invoice::where('sub_order_id', $this->sub_order_id)->where('active', 's')->where('invoice_status_id', 1)->get();
    }
}