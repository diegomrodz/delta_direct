...
class CustomerCreditAnalysis extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'customer_credit_analysis';
     ...
     * @var string
     */
    protected $primaryKey = 'customer_credit_analysis_id';
    ...
    protected $fillable = ['customer_id', 
                           'representant_id', 
                           'manager_id', 
                           'customer_credit_analysis_status_id',
                           'customer_credit_analysis_range_id',
                           'observation',
                           'first_order_value',
                           'credit_required',
                           'cnpj_filepath',
                           'ie_filepath',
                           'social_contract_filepath',
                           'dre_filepath',
                           'active', 
                           'created_at', 
                           'updated_at'];
    ...
    {
        return Customer::where('customer_id', $this->customer_id)->first();
    }
    
    public function representant() 
    {
        return Representant::where('representant_id', $this->representant_id)->first();
    }
    
    public function manager() 
    {
        return Manager::where('manager_id', $this->manager_id)->first();
    }
    
    public function getRequest($dist) 
    {
        return CustomerCreditAnalysisRequest::where('customer_credit_analysis_id', $this->customer_credit_analysis_id)
                                            ->where('distribuitor_id', $dist)
                                            ->where('customer_credit_analysis_request_status_id', 2)
                                            ->first();
                                            
    }

    public function getRepAnalysisNotes() 
    {
        return CustomerCreditAnalysisNote::where('customer_credit_analysis_id', $this->customer_credit_analysis_id)->get();
    }
    
    public function getAnalysisNotes($distribuitor) 
    {
        return CustomerCreditAnalysisRequestNote::where('distribuitor_id', $distribuitor)
                                                ->where('customer_credit_analysis_id', $this->customer_credit_analysis_id)
                                                ->get();
    }
    
    public function getStatus() 
    {
        return CustomerCreditAnalysisStatus::where('customer_credit_analysis_status_id', $this->customer_credit_analysis_status_id)->first();
    }
    
    public function getRange() 
    {
        return CustomerCreditAnalysisRange::where('customer_credit_analysis_range_id', $this->customer_credit_analysis_range_id)->first();
    }
    
    public function getRanges() 
    {
        return CustomerCreditAnalysisRange::where('active', 's')->get();
    }
}