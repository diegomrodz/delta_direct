...
class CustomerSanitaryWareSupplier extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'customer_sanitary_ware_supplier';
    ...
    public function getSanitaryWareSupplier() 
    {
        return SanitaryWareSupplier::where('sanitary_ware_supplier_id', $this->sanitary_ware_supplier_id)->first();
    }
