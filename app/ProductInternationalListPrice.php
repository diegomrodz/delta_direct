...
class ProductInternationalListPrice extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'product_international_list_price';
     ...
     * @var string
     */
    protected $primaryKey = 'product_international_list_price_id';
     ...
     * @var array
     */
    protected $fillable = ['value', 'discount', 'dollar_real_ratio', 'dollar_considered', 'real_considered', 'created_at', 'updated_at'];
