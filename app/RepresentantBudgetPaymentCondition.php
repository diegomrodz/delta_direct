...
class RepresentantBudgetPaymentCondition extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'representant_budget_payment_condition';
     ...
     * @var string
     */
    protected $primaryKey = 'representant_budget_payment_condition_id';
