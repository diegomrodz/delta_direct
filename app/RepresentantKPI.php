...
class RepresentantKPI extends Model
{
	    /**
     ...
     * @var string
     */
    protected $table = 'representant_kpi';
     ...
     * @var array
     */
    protected $fillable = ['representant_id', 'report_kpi_id',
						   'kpi_total', 'kpi_goal_1', 'kpi_goal_2', 'kpi_goal_3',
						   'kpi_goal_4', 'kpi_goal_5', 'kpi_goal_6', 'kpi_goal_7',
						   'kpi_goal_8', 'kpi_goal_9', 'kpi_goal_10', 'kpi_goal_11',
						   'kpi_goal_12', 'active', 'created_at', 'updated_at'];
