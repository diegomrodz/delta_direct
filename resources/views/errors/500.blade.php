...
<body class="page-500" style="">
    ...
    <div class="error-text">
        <span class="oops">OUCH!</span>
        <br>
        <span class="hr"></span>
        <br>Houve um erro interno do servidor.
        <br>
        <span class="solve">Nós eperamos resolvê-lo o mais rápido possivel.</span>
    </div>
    <!-- / .error-text -->
