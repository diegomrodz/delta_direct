<div class="col-sm-12">
    <div class="panel widget-chat">
        <div class="panel-heading">
            <span class="panel-title"><i class="panel-title-icon fa fa-comments-o"></i>Anotações do produto: {{$product->sku}}</span>
        </div>
        <!-- / .panel-heading -->
...
<script type="text/javascript">
        $("#btn_send_product_note").click(function () {
            ...
            var req = $.ajax({
                url: "http://deltafaucetrep.com/order/{{$order->order_id}}/product/{{$product->product_id}}/notes",
                type: "POST",
                data: data,
                dataType: 'json'
            });
