<div class="col-sm-12">
    <div class="panel widget-chat">
        <div class="panel-heading">
            <span class="panel-title"><i class="panel-title-icon fa fa-comments-o"></i>Anotações do pedido: {{$order->distribuitor()->delta_code . $order->order_id}}</span>
        </div>
        <!-- / .panel-heading -->
...
<script type="text/javascript">
        $("#btn_send_product_note").click(function () {
            ...
            var req = $.ajax({
                url: "http://deltafaucetrep.com/sub_order/{{$order->sub_order_id}}/notes",
                type: "POST",
                data: data,
                dataType: 'json'
            });
