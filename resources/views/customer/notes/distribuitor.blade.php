    ...
    <div class="panel widget-chat">
        ...
        <div class="panel-body">
            <div id="slim_sroll_chat">
                @foreach($ca->getAnalysisNotes($dist->distribuitor_id) as $note)
...
<script type="text/javascript">
    $("#btn_send_product_note").click(function () {
        ...
        var req = $.ajax({
            url: "http://deltafaucetrep.com/customer/credit_analysis/notes/{{$ca->customer_credit_analysis_id}}/from/{{$dist->distribuitor_id}}",
            type: 'post',
            data: data,
            dataType: 'json'
        });
