...
<table cellspacing="0" border="0">
    ...
    <tr>
        <td colspan=12 height="17" align="right" valign=middle>
            Clique na imagem para imprimir: <a href="http://deltafaucetrep.com/order/print/{{$order->order_id}}"><img width=46 height=46 src="http://static.deltafaucetrep.com/assets/images/print-printer-icon.png" alt=""></a>
        </td>
    </tr>
	<tr>
	...
	<tr>
		...
		<td colspan=5 align="left" valign=middle>{{$order->customer()->getBusinessContacts()[0]->name}}, {{$order->customer()->getBusinessContacts()[0]->dept}}</td>
		<td align="left"><br></td>
		<td align="left"><br></td>
		<td style="border-right: 1px solid #000000" align="left"><br></td>
	</tr>
	<tr>
		<td style="border-left: 1px solid #000000" colspan=3 height="18" align="left" valign=middle><font color="#000000">{{$order->representant() == null ? "diego.rodrigues@deltafaucet.com" : $order->representant()->user()->email}}</font></td>
		<td colspan=5 align="left" valign=middle>{{$order->customer()->phone}} / {{$order->customer()->getBusinessContacts()[0]->phone}}</td>
	...
	<tr>
		...
		<td colspan=5 align="left" valign=middle>{{$order->customer()->email}}  / {{$order->customer()->getBusinessContacts()[0]->email}}</td>
		<td style="border-right: 1px solid #000000" colspan=3 align="left" valign=middle>{{$order->payment_details}}</td>
		</tr>
	<tr>
