...
$.fn.editInPlace.defaults = {
	...
	default_text:		"(Clique aqui para editar)", // string: text to show up if the element that has this functionality is empty
	...
	select_text:		"Escolha o novo valor", // string: default text to show up in select box
